...
# 初值
x_train_bc = torch.tensor([[0.], [1.2]])
y_train_bc = torch.tensor([[-8., 7., 27.], [5.44642963, 4.66782457, 14.69456692]])
...
scheduler = torch.optim.lr_scheduler.ReduceLROnPlateau(optimizer, min_lr=1e-7, mode='min', factor=0.5, patience=20000,
                                                       verbose=True)
...
plt.savefig('./figure/lorenz63_pinn_02_2d.png')
plt.close()
# plt.show()
...
plt.savefig('./figure/lorenz63_pinn_02_3d.png')
# plt.show()
