...
if "__main__" == __name__:
    ...
    obs = np.load('lorenz63_rho_28_interval_0.005_total_point_301.npy')
    # 选取观测值
    idx = [i for i in range(0, len(obs), 100)]
    ...
    plt.savefig('./figure/lorenz63_dnn_obs_02_2d.png')
    plt.close()
    # plt.show()
    ...
    ax.set_zlabel('z')
    ax.set_title('lorenz63')
    plt.savefig('./figure/lorenz63_dnn_obs_02_3d.png')
    # plt.show()
