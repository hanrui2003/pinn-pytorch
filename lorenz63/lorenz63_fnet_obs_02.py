...
class FCN(nn.Module):
    ...
    def __init__(self, layers):
        ...
        self.activation2 = lambda x: torch.sin(x)
    ...
    def forward(self, x):
        ...
        for j in range(1, len(self.linears) - 1):
            z = self.linears[j](a)
            a = self.activation1(z)
...
if "__main__" == __name__:
    ...
    plt.savefig('./figure/lorenz63_fnet_obs_02_2d.png')
    plt.close()
    # plt.show()
    ...
    ax.set_zlabel('z')
    ax.set_title('lorenz63')
    plt.savefig('./figure/lorenz63_fnet_obs_02_3d.png')
    # plt.show()
