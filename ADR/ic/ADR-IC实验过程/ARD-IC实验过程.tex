...
考虑一个本金为P，年利率为r的债券，按照连续复利，每时每刻的利率是$r_{c}=e^{r}-1$，其中$e$是自然对数的底数。假设持有该债券t年，则连续复利后的本金总额是：

$P_{c}=P \cdot e^{rt}$

推导过程如下：

根据连续复利的定义，我们可以将一年分成n个等分，每个等分的时间间隔为$\frac{1}{n}$年，每个等分内的复利率为：
...
所以一年后，本金为P的债券按照连续复利的复利因子为：

$e^{r}$

持有t年后，本金为P的债券按照连续复利的复利因子为：
