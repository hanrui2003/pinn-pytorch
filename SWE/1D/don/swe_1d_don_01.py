...
if "__main__" == __name__:
    ...
    batch_size_ic = 101 * batch_size_factor
    batch_size_bc = 102 * batch_size_factor
    batch_size_physics = 200 * batch_size_factor
    print("batch_size_ic:", batch_size_ic, "batch_size_bc:", batch_size_bc, "batch_size_physics:", batch_size_physics)

    ic_loader = DataLoader(ic_ds, batch_size=batch_size_ic, shuffle=True)
    bc_loader = DataLoader(bc_ds, batch_size=batch_size_bc, shuffle=True)
    physics_loader = DataLoader(physics_ds, batch_size=batch_size_physics, shuffle=True)
