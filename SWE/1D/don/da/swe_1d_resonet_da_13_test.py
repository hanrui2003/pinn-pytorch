...
from swe_1d_resonet_da_13 import ResidualNetwork
...
if "__main__" == __name__:
    ...
    ic = seq[0] + 0.2 * noise_dataset[seq_idx][0] - 0.03
    ...
    model.load_state_dict(torch.load('swe_1d_resonet_da_13_2e-5.pt', map_location=torch.device('cpu')))
    model.eval()
    print("model", model)
