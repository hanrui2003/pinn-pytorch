...
if "__main__" == __name__:
    ...
    # 构建网络网络结构
    model = ResidualNetwork(input_size=183, hidden_size=256, num_blocks=2, output_size=2)
    model.apply(weights_init)
    model.to(device)
    print("model:\n", model)

    old_model_weights_path = 'swe_1d_resonet_da_05_1e-3.pt'
    new_model_weights_path = 'swe_1d_resonet_da_05_5e-5.pt'
    save_threshold = 5e-5
