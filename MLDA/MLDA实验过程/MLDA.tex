...
\subsection{PINN解偏微分方程}
\subsection{通用逼近定理}
通用逼近定理（Universal approximation theorem）有多个版本，最早的版本可以追溯到1989年，由George Cybenko在他的论文\cite{cybenko1989approximation}中提出。这里我们给出一个可变宽度的版本：
\begin{theorem}
	dddddd
\end{theorem}
