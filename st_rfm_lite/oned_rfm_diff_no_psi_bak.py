...
def main(Nx, Nt, M, Qx, Qt):
    ...
    true_values_, numerical_values_, L_i, L_2 = test(models=models, Nx=Nx, Nt=Nt, M=M, Qx=Qx, Qt=Qt,
...
def test(models, Nx, Nt, M, Qx, Qt, w, X_min, X_max, T_min, T_max):
    ...
    return true_values, numerical_values, L_inf, L_2
