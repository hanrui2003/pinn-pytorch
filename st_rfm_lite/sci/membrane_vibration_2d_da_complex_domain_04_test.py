...
import math
from membrane_vibration_2d_da_complex_domain_04 import u_real, LocalNet, pick_point, circles
...
if __name__ == '__main__':
    ...
    data = np.load("membrane_vibration_2d_da_complex_domain_04_250.npz")
    Nx, Ny, Nt, M, Qx, Qy, Qt, X_min, X_max, Y_min, Y_max, T_min, T_max = data['config']
    w = data['w']

    models = torch.load('membrane_vibration_2d_da_complex_domain_04_250.pt')
